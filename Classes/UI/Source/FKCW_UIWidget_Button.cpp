...
//-------------------------------------------------------------------------
FKCW_UIWidget_Button* FKCW_UIWidget_Button::createWithSpriteFrameName(const char* pNormal, const char* pSelected, const char* pDisabled)
{
	FKCW_UIWidget_Button* pRet = new FKCW_UIWidget_Button();
	if (pRet && pRet->initWithSpriteFrameName(pNormal, pSelected, pDisabled))
	{
		pRet->autorelease();
		return pRet;
	}
...
//-------------------------------------------------------------------------
bool FKCW_UIWidget_Button::initWithSpriteFrameName(const char* pNormal, const char* pSelected, const char* pDisabled)
{

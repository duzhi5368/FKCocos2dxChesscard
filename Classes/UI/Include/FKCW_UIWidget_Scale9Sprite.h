//*************************************************************************
//	创建日期:	2014-12-4
//	文件名称:	FKCW_UIWidget_Scale9Sprite.h
//  创 建 人:   FreeKnight	
//	版权所有:	MIT
//	说    明:	
//*************************************************************************
 ...
 * scaled.
 *
 * @see http://yannickloriot.com/library/ios/cccontrolextension/Classes/FKCW_UIWidget_Scale9Sprite.html
 */
class FKCW_UIWidget_Scale9Sprite : public CCNodeRGBA
{
public:
    FKCW_UIWidget_Scale9Sprite();
    virtual ~FKCW_UIWidget_Scale9Sprite();
...
public:
     ...
     */
    static FKCW_UIWidget_Scale9Sprite* create(const char* file, CCRect rect,  CCRect capInsets);
     ...
     */
    static FKCW_UIWidget_Scale9Sprite* create(const char* file, CCRect rect);
     ...
     */
    static FKCW_UIWidget_Scale9Sprite* create(CCRect capInsets, const char* file);
     ...
     * @see initWithFile:
     */
    static FKCW_UIWidget_Scale9Sprite* create(const char* file);
     ...
     */
    static FKCW_UIWidget_Scale9Sprite* createWithSpriteFrame(CCSpriteFrame* spriteFrame, CCRect capInsets); 
    /**
     ...
     */
    static FKCW_UIWidget_Scale9Sprite* createWithSpriteFrame(CCSpriteFrame* spriteFrame);  
     ...
     */
    static FKCW_UIWidget_Scale9Sprite* createWithSpriteFrameName(const char*spriteFrameName, CCRect capInsets); 
     ...
     */
    static FKCW_UIWidget_Scale9Sprite* createWithSpriteFrameName(const char*spriteFrameName);
     ...
     * @param capInsets The values to use for the cap insets.
     */
    FKCW_UIWidget_Scale9Sprite* resizableSpriteWithCapInsets(CCRect capInsets);
    
    static FKCW_UIWidget_Scale9Sprite* create();

	void setTexture(CCTexture2D* pTexture);
	virtual bool initWithTexture(CCTexture2D* pTexture);
	virtual bool initWithTexture(CCTexture2D* pTexture, CCRect capInsets);
	static FKCW_UIWidget_Scale9Sprite* createWithTexture(CCTexture2D* pTexture);
	static FKCW_UIWidget_Scale9Sprite* createWithTexture(CCTexture2D* pTexture, CCRect capInsets);

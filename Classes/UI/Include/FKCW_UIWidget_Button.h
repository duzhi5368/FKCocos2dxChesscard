...
public:
	...
	virtual bool		init();
	virtual bool		initWithSpriteFrameName(const char* pNormal, const char* pSelected, const char* pDisabled);
	...
	static FKCW_UIWidget_Button*		createWithSpriteFrameName(const char* pNormal, const char* pSelected = NULL, const char* pDisabled = NULL);
